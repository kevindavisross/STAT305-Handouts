...
In the meeting problem, assume the two arrival times $X$ and $Y$ each have a Uniform(0, 60) distribution, independently.
Let $T=\min(X, Y)$ be the time of the first arrival and let $W=|X-Y|$ be the waiting time of the first person for the second to arrive.  
:::
