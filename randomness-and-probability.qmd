...
1.  The probability that the high temperature in San Luis Obispo next Tuesday is above 80 degrees F.
...
1.  The probability that you ate an apple on April 17, 2014.
...
You flip a coin 10 times and it lands on heads 7 times. 
Is it true that the probability that the coin lands on heads is 7/10=0.7?
Explain.
:::
...
What is your subjective probability that Prof. Ross saw Taylor Swift's Eras Tour live in concert?
...
What does this say about your subjective probability that Prof Ross saw the Eras Tour live?
...
As of Jan 3, [ESPN](https://www.espn.com/espn/betting/story/_/id/43748901/super-bowl-2026-odds-win-nfl-betting) listed the following probabilities for who will win the 2026 Superbowl.
:::
...
\
\
1.  What must be the probability that a team other than the above six teams wins the championship?
...
\
\
1.  The Seahawks are how many times more likely than the Eagles to win?
The Seahawks are how many times more likely than the Broncos to win?
\
\
\
\
\
1.  What must be the probability that the 49ers do *not* win the championship?
How many times more likely are the 49ers to not win than to win (this ratio is the "odds against" the 49ers winning).
\
\
\
\
\
1.  How could you construct a circular spinner (like from a kids game) to simulate the champion according to these probabilities? According to this model, what would you expect the results of 10000 repetitions of a simulation of the champion to look like?
\
\
\
\
...
Suppose your subjective probabilities for the 2026 Superbowl satisfy the following conditions.
...
(Neither has any direct information about whether or not Prof Ross saw the Eras Tour.)
