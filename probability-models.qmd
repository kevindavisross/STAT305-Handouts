...
::: {#exm-die-fair}
Suppose that the playoff for some sport is down to the final 4 teams, which we'll label teams 1, 2, 3, 4 (in no particular order).
We're interested in which team will win the championship.
...
\
\
1.  Pat assumes that the four teams are equally likely to win the championship. 
Let $\text{P}$ denote Pat's correponding probability measure.
...
| $A$ | Description | $\text{P}(A)$ | $\text{Q}(A)$ | $\tilde{\text{P}}(A)$|
| --- | --- | --- | --- | --- |
| $\emptyset$ | &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |  | | |
$\{1\}$ | |  | | |
$\{2\}$ | |  | | |
...
::: {#exm-die-weighted}
Continuing @exm-die-fair.
Quentin assumes the teams are not equally likely to win the championship.
Let $\text{Q}$ denote Quentin's probability measure.
A few probabilities are provided in @tbl-die-events; compute $\text{Q}(A)$ for all other events in @tbl-die-events.
What is Quentin's assumed probability that each team wins the championship?
\
\
\
\
...
Let $\tilde{\text{P}}$ denote Tilda's probability measure.
Compute $\tilde{\text{P}}(A)$ for all events in @tbl-die-events.
What is Tilda's assumed probability that each team wins the championship?
\
\
\
\
...
Continuing with the uniform probability measure $\textbf{P}$ of @exm-meeting-probspace1d-uniform.
...
Continuing with the non-uniform probability measure $\textbf{Q}$ of @exm-meeting-nonuniform-probspace1.
